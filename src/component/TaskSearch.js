    ...
    <div className="flex w-1/3">
      <div className="w-[700px]">
        <div className="input-group relative flex flex-wrap items-stretch w-full mb-4 rounded">
          ...
          />
          <button
            className="bg-red-300 input-group-text flex items-center px-3 py-1.5 text-base font-normal text-gray-700 text-center whitespace-nowrap rounded"
            id="basic-addon2"
            onClick={() => dispatch(searchData(keyword.current.value))}
          >
            <svg
              aria-hidden="true"
              focusable="false"
